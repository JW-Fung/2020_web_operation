...
# 用WAI原则评论[topys网站](https://www.topys.cn/)

## 提供内容丰富，独特的页面标题
![](images/WAI1.1.png)
### 评论：
页面标题简单明了，“|”前面是网站名字，后面是对这个网站的总述。清楚明了地告诉别人这是什么网站以及这是一个什么性质的网站。

![](/images/WAI1.2.png)
![](/images/WAI1.3.png)
![](/images/WAI1.4.png)
### 评论：
网站里面的每个页面标题与网站首页的主要标题相同。将独特且最相关的信息放在首位，“|”前面是该类别的名称，后面则是该网站主要页面的页面标题名字，让人们浏览的时候能够快速分清那是一个怎样的页面。比如该网站里创意类页面的页面标题是“创意|TOPYS 全球顶尖创意分享平台 OPEN YOUR MIND”。
...
![](/images/WAI2.3.png)
### 评论：
该网站里面的文章有使用标题和主标题。文章的开头使用级别较高的标题，字号比下面的文章内容的字都要大，能让人清楚地知道这是文章的标题，并且标题具有概括性，让读者知道该文章的主要内容是什么。文章分为不同的段落，不同的内容前会有一个标题。


## 
![](/images/WAI3.1.png)
### 评论：
编写链接文本，以描述链接目标的内容。例如“创意学院”。
...
topys上大多数图片没有设置文字替代  
如上图，该图片可用【扫描二维码下载iOS、Android版本】来替代

---
## 创建多媒体文字记录和字幕
![](/images/WAI5.1.png)
### 评论1： 
topys在本多媒体中加入了文字提示，提示了影片的背景，帮助理解。
![](/images/WAI5.2.png)
### 评论2：  

topys在本多媒体中加入了字幕，帮助表述画面，让对话更好理解。
![](/images/WAI5.3.png)
### 评论3：  

topys在部分无对话有背景音乐的视频中没有加入文字记录和描述，可加入【某某音乐的名称】帮助理解。
...
topys网页的指示明确，易于理解，在上图中都有对用户的操作进行引导。
